...
module.exports = function(options) {
  ...
  var onMediaQueryChange = function(event, newMediaQuery) {
    updateImages(newMediaQuery);
  };
  ...
  var updateImages = function (newMediaQuery) {
    ...
    $.each(knownSizes, function (i) {
      ...
      if (!newSource) {
        var
          ii = sassqwatch.mqOrderNamed[newMediaQuery],
          thisMQ;

        // decrement through the numbered mq's
        for (ii; ii > 0; ii--) {
          thisMQ = sassqwatch.mqOrderNumbered[ii];
  ...
  sassqwatch.listenElement.on('mediaQueryChange', onMediaQueryChange);
};
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./elementify":1,"./preloader":2,"./sassqwatch":4,"./toDashed":7}],4:[function(require,module,exports){
(function (global){

// sassqwatch 0.1.0// Dependencies
var
  $ = (typeof window !== "undefined" ? window.$ : typeof global !== "undefined" ? global.$ : null),
...
var onResize = function () {
  ...
  if (currentMediaQuery != lastQuery) {
    ...
    $listenElement.trigger('mediaQueryChange', [currentMediaQuery, lastQuery]);
  }
};
...
(function() {
  ...
  sassqwatch = {
    ...
    mqOrderNamed: mqOrderNamed,
    mqOrderNumbered: mqOrderNumbered,
    isAbove: isAbove,
    isBelow: isBelow,
...
},{"./responsiveImages":3,"./throttleDebounce":6}],5:[function(require,module,exports){
(function (global){
var $ = (typeof window !== "undefined" ? window.$ : typeof global !== "undefined" ? global.$ : null),
	sassqwatch = require('./sassqwatch');
...
},{"./sassqwatch":4}],6:[function(require,module,exports){
var jq_throttle;
